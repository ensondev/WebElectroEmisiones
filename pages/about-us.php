...
<head>
    ...
    <link rel="stylesheet" href="../public/css/conocenos.css">
        ...
        <section class="contenedor-conocenos">
            <div class="sub-contenedor__conocenos">
                <div class="contenedor-imagen__conocenos">
                    <img src="../public/image/otros/conocenos_img.webp" alt="imagen de trabajador dandole mantenimiento a un vehiculo">
                </div>
